...
# [0.02286306624505871, 0.006664893563718397, 0.04919056936448101, 0.0641710760794603, 0.18722571529139112, 0.20422236480344202, 0.3526112932647866, 0.5627408837249435, 0.7781771926471283]
# [5.33544010742013, 6.281457431220113, 4.525013922549082, 4.046376573811409, 3.177055998661066, 2.861503960558995, 2.481221151158959, 2.3439935364076927, 1.2124027823749035]
#0.02057


# [0.01795661023850331, 0.005234595164183904, 0.03863418283533817, 0.050399845296046054, 0.14704673293063214, 0.16039587024130708, 0.2769402621233624, 0.4419756565462276, 0.611178937902837]
# [-0.025636666666666665, 0.020720000000000002, 0.023043333333333336, -0.009602500000000002, -0.00657, -0.011835833333333332, 0.004365, -0.002761875, 0.0028388541666666666]
import numpy as np
# [0.23939, 0.010928, 0.0078216, 0.0080172, 0.066145, 0.00095812, 0.11936, 0.01543, 0.0052825]
# [-1.5382, 1.2432, 2.7652, -1.1523, -1.5768, -2.8406, 1.5714, -1.3257, 2.7253]
# =============================================================================
# YOUR DATA:
# =============================================================================
trans_data = [0.01795661023850331, 0.005234595164183904, 0.03863418283533817, 0.050399845296046054, 0.14704673293063214, 0.16039587024130708, 0.2769402621233624, 0.4419756565462276, 0.611178937902837]
trans_periods = [60, 60, 120, 120, 240, 240, 360, 480, 960] #input the corresponding periods here (s)
phase_data = [np.pi*2 - 5.33544010742013, np.pi*2 - 6.281457431220113, np.pi*2 - 4.525013922549082, np.pi*2 - 4.046376573811409, 3.177055998661066, 2.861503960558995, 2.481221151158959, 2.3439935364076927, 1.2124027823749035]
phase_periods = [60, 60, 120, 120, 240, 240, 360, 480, 960]#input the corresponding periods here (s)
r_out = 0.02057/2 #outer radius (m)
