...
square_fit, square_cov = curve_fit(sinusodial, x1, y1, p0=[10.3, -0.00264, 0, 52])
square_wave = -square_fit[0] * sp.signal.square(2 * np.pi * (0.5/1240.7) * x1) + square_fit[3]

plt.figure()
plt.plot(x1, sinusodial(x1, *square_fit), **lineStyleBold, label="Sinusodial Fit")
plt.plot(x1, square_wave, **lineStyleBold1, label="Square Wave")
plt.plot(x1,y1, **lineStyle, label="Data")
plt.title("Thermalization of a System", **titleFont)
